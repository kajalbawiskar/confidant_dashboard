...
const Footer = () => (
  <div className="flex flex-col bg-white text-gray-800 py-4 lg:py-6 shadow-xl border-t border-gray-300 lg:mr-96 fixed bottom-0  lg:w-full z-50">
    <div className="container mx-auto flex justify-between items-center">
      <div>
        ...
        >
          <img src={confi} alt="Confidanto Logo" className="w-16 lg:w-44 pl-4" />
        </a>
      </div>
