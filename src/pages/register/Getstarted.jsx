...
import { DigitalMarketing, GoogleLogo, confilogo } from "../logo/index";
  ...
  return (
    <div className="bg-white overflow-auto">
      ...
      <div className="min-h-screen flex justify-center bg-cover bg-center bg-transparent w-full">
        <div className="w-4/6 h-fit bg-white bg-opacity-75 rounded-lg px-8 pb-4 mt-8 mb-4 shadow-xl">
          <h2 className="mt-4 text-center text-4xl lg:text-4xl font-bold text-gray-900">
            Hello {firstName} 👋 <br />
            Welcome to Confidanto
          </h2>
          <p className="mt-6 text-center text-xl lg:text-xl font-medium text-gray-500">
          ...
          <div className="flex justify-center w-full">
            <img src={DigitalMarketing} alt="Loading" className="h-96 w-full" />
          </div>
